...
//                Log.e(
//                    TAG,
//                    "height " + height + " ,percent " + percent + " ,imageHight " + imageHight
//                )
...
//                val percent =
//                    (scrollY.toFloat() / (scrollContentHeight - screenHeight + statusBarHeight).toFloat()).toDouble()
//                if (percent >= 0 && percent <= 1) toolbar.setBackgroundColor(
//                    Color.argb(
//                        (255.0 * percent).toInt(),
//                        r,
//                        g,
